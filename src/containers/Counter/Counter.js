...
import {INCREMENT, DECREMENT, ADD_FIVE, SUBTRACT_FIVE, STORE_RESULT, DELETE_RESULT} from '../../store/ActionTypes';
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onDeleteResult: (idToDelete) => dispatch({type: DELETE_RESULT, id: idToDelete})
    };
}
